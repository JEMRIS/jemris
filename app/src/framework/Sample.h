...
class Sample {
 ...
 public:
     ...
     *
     * @param val Width of the Gaussian distribution in Hz.
     */
     ...
     * @param val Width of the Gaussian distribution in Hz.
     */
    void    SetLocalFieldFluctuations   (double val) {m_lff = val;};
     ...
     * file, plus the random field fluctuation specified by SetLocalFieldFluctuations.
     *
    ...
    Spin         spins;      /** < My public spins structure          */
 ...
 private:
    ...
    double       m_lff;        /** < Width of a Gaussian distribution in Hz.*/
