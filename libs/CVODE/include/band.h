 ...
 * other set uses the type cvreal ** for band matrix arguments.     *
 ...
 *                                                                *
 * (2) The set of routines that use cvreal ** (and NOT the BandMat  *
 ...
 *                                                                * 
 * Routines that work with cvreal ** begin with "band" (except for  *
 ...
 * the expression BAND_COL(A,j) is cvreal *. The pointer returned   *
...
void BandScale(cvreal c, BandMat A);
...
/* Functions that use the cvreal ** representation for a band matrix */
 ...
 * (2) Pass smu = MIN(n-1,mu+ml) if A will be factored.           *
 *                                                                *
 * The underlying type of the band matrix returned is cvreal **. If *
 * we allocate a band matrix A in cvreal **a by                     *
...
cvreal **bandalloc(integer n, integer smu, integer ml);
...
integer gbfa(cvreal **a, integer n, integer mu, integer ml, integer smu,
             integer *p);
...
void gbsl(cvreal **a, integer n, integer smu, integer ml, integer *p, cvreal *b);
...
void bandzero(cvreal **a, integer n, integer mu, integer ml, integer smu);
...
void bandcopy(cvreal **a, cvreal **b, integer n, integer a_smu, integer b_smu,
...
void bandscale(cvreal c, cvreal **a, integer n, integer mu, integer ml,
               integer smu);
...
void bandaddI(cvreal **a, integer n, integer smu);
...
void bandprint(cvreal **a, integer n, integer mu, integer ml, integer smu);
