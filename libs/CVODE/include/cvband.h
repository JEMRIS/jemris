 ...
 *                                                                *
 * iopt[BAND_LRW] : size (in cvreal words) of cvreal workspace        *
...
typedef void (*CVBandJacFn)(integer N, integer mupper, integer mlower,
                            BandMat J, RhsFn f, void *f_data, cvreal t,
                            N_Vector y, N_Vector fy, N_Vector ewt, cvreal h,
                            cvreal uround, void *jac_data, long int *nfePtr,
...
void CVBandDQJac(integer N, integer mupper, integer mlower, BandMat J,
		 RhsFn f, void *f_data, cvreal t, N_Vector y, N_Vector fy,
		 N_Vector ewt, cvreal h, cvreal uround, void *jac_data,
