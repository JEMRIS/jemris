 ...
 *   ...                                                          *
 *   bp_data = CVBandPcvrealloc(N, f, f_data, mu, ml);              *
 *   ...                                                          *
 ...
 * (2) In the CVBandPcvrealloc call, the arguments N, f, and f_data *
 ...
 *     last argument being the pointer returned by CVBandPcvrealloc.*
...
typedef struct {
  /* Data set by user in CVBandPcvrealloc: */
  RhsFn f;
  void *f_data;
  integer ml, mu;
...
/******************************************************************
 *                                                                *
 * Function : CVBandPcvrealloc                                      *
 *----------------------------------------------------------------*
 * CVBandPcvrealloc allocates and initializes a CVBandPreData       *
 * structure to be passed to CVSpgmr (and subsequently used by    *
 * CVBandPrecond and CVBandPSolve).                               *
 *                                                                *
 * The parameters of CVBandPcvrealloc are as follows:               *
 *                                                                *
 ...
 *                                                                *
 * CVBandPcvrealloc returns the storage pointer (type CVBandPreData)*
 * or NULL if the request for storage cannot be satisfied.        *
 *                                                                *
 ******************************************************************/

CVBandPreData CVBandPcvrealloc(integer N, RhsFn f, void *f_data,
 ...
 *----------------------------------------------------------------*
 * CVBandPreFree frees the memory allocated by CVBandPcvrealloc in  *
 * the argument pdata.                                            *
 *                                                                *
 ******************************************************************/
...
int CVBandPrecond(integer N, cvreal t, N_Vector y, N_Vector fy, boole jok,
                  boole *jcurPtr, cvreal gamma, N_Vector ewt, cvreal h,
                  cvreal uround, long int *nfePtr, void *bp_data,
                  N_Vector vtemp1, N_Vector vtemp2, N_Vector vtemp3);


int CVBandPSolve(integer N, cvreal t, N_Vector y, N_Vector fy, N_Vector vtemp,
                 cvreal gamma, N_Vector ewt, cvreal delta, long int *nfePtr,
