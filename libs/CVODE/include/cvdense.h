 ...
 *                                                                *
 * iopt[DENSE_LRW] : size (in cvreal words) of cvreal workspace       *
...
typedef void (*CVDenseJacFn)(integer N, DenseMat J, RhsFn f, void *f_data,
                             cvreal t, N_Vector y, N_Vector fy, N_Vector ewt,
                             cvreal h, cvreal uround, void *jac_data,
...
void CVDenseDQJac(integer N, DenseMat J, RhsFn f, void *f_data, cvreal t,
		  N_Vector y, N_Vector fy, N_Vector ewt, cvreal h, cvreal uround,
