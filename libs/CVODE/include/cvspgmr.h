 ...
 *                                                                *
 * iopt[SPGMR_LRW]  : size (in cvreal words) of cvreal workspace      *
...
typedef int (*CVSpgmrPrecondFn)(integer N, cvreal t, N_Vector y, N_Vector fy,
...
typedef int (*CVSpgmrPSolveFn)(integer N, cvreal t, N_Vector y, N_Vector fy,
...
void CVSpgmr(void *cvode_mem, int pretype, int gstype, int maxl, cvreal delt,
