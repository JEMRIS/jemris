 ...
 * other set uses the type cvreal ** for dense matrix arguments.    *
 ...
 *                                                                *
 * (2) The set of routines that use cvreal ** (and NOT the DenseMat *
 ...
 *                                                                * 
 * Routines that work with cvreal ** begin with "den" (except for   *
 ...
 * DENSE_COL(A,j) is cvreal *. After the assignment in the usage    *
...
void DenseScale(cvreal c, DenseMat A);
...
/* Functions that use the cvreal ** representation for a dense matrix */
 ...
 * returned is cvreal **. If we allocate a dense matrix cvreal **a by *
...
integer gefa(cvreal **a, integer n, integer *p);
...
void gesl(cvreal **a, integer n, integer *p, cvreal *b);
...
void denzero(cvreal **a, integer n);
...
void dencopy(cvreal **a, cvreal **b, integer n);
...
void denscale(cvreal c, cvreal **a, integer n);
...
void denaddI(cvreal **a, integer n);
...
void denprint(cvreal **a, integer n);
