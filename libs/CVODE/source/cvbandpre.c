...
static void CVBandPDQJac(integer N, integer mupper, integer mlower, BandMat J,
		         RhsFn f, void *f_data, cvreal tn, N_Vector y,
		         N_Vector fy, N_Vector ewt, cvreal h, cvreal uround,
...
int CVBandPrecond(integer N, cvreal t, N_Vector y, N_Vector fy,
                  boole jok, boole *jcurPtr, cvreal gamma,
                  N_Vector ewt, cvreal h, cvreal uround,
...
int CVBandPSolve(integer N, cvreal t, N_Vector y, N_Vector fy,
                 N_Vector vtemp, cvreal gamma, N_Vector ewt,
                 cvreal delta, long int *nfePtr, N_Vector r,
...
static void CVBandPDQJac(integer N, integer mupper, integer mlower, BandMat J,
		         ...
		         N_Vector ftemp, N_Vector ytemp)
{
  cvreal    fnorm, minInc, inc, inc_inv, srur;
  integer group, i, j, width, ngroups, i1, i2;
  cvreal *col_j, *ewt_data, *fy_data, *ftemp_data, *y_data, *ytemp_data;
