...
typedef struct {
  ...
  cvreal g_sqrtN;       /* sqrt(N)                                      */
  cvreal g_delt;        /* delt = user specified or DELT_DEFAULT        */
  cvreal g_deltar;      /* deltar = delt * tq4                          */
  cvreal g_delta;       /* delta = deltar * sqrtN                       */
