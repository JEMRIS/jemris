...
int ModifiedGS(N_Vector *v, cvreal **h, int k, int p, cvreal *new_vk_norm)
{
  int  i, k_minus_1, i0;
  cvreal new_norm_2, new_product, vk_norm, temp;
...
int ClassicalGS(N_Vector *v, cvreal **h, int k, int p, cvreal *new_vk_norm,
		N_Vector temp, cvreal *s)
{
  int  i, k_minus_1, i0;
  cvreal vk_norm;
...
int QRfact(int n, cvreal **h, cvreal *q, int job)
{
  cvreal c, s, temp1, temp2, temp3;
...
int QRsol(int n, cvreal **h, cvreal *q, cvreal *b)
{
  cvreal c, s, temp1, temp2;
