...
#ifndef _LTASPIRALGRADPULSE_H
#define _LTASPIRALGRADPULSE_H
...
class LTASpiralGradPulse : public GradPulse {
 ...
 public:
     ...
     * Copy constructor.
     */
    LTASpiralGradPulse               (const LTASpiralGradPulse&) {};
     ...
     *  See Module::clone
     */
    inline LTASpiralGradPulse* Clone () const {return (new LTASpiralGradPulse(*this));};
